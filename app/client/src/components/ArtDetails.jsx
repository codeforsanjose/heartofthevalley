        ...
        <div className="artDetailsPage container mt-4">
            <div className="imageSection ">
                ...
                <div className="titleSection d-flex justify-content-between my-5">
                    <h4>{title}</h4>
                    <div className="flagSection"><button><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-flag" viewBox="0 0 16 16">
            ...
            <div className="detailsSection d-flex justity-content-between my-5">
                ...
                <img className="img w-100 art-img-fit" style={{height:"55vh", borderRadius:"25px", marginBottom: "1vh"}}src={imgAddr} alt="Image address"/>
                    <p>WHERE</p>
                    <p>{facility}</p>
